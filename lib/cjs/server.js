...
var ServerAuth = /** @class */ (function () {
    function ServerAuth(config) {
        ...
        this.buildCookie = function (key, value, config) {
            ...
            return "".concat(key, "=").concat(value, "; Path=/; SameSite=Strict; Secure").concat(config.expires
         ...
         */
        this.refreshSession = function (res, refreshToken, shouldRetry) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.handlers.refresh.fetch(refreshToken)];
                        case 1:
                            response = _a.sent();
                            if (!!response.ok) return [3 /*break*/, 4];
                            if (!shouldRetry) return [3 /*break*/, 3];
                            return [4 /*yield*/, this.refreshSession(res, refreshToken, false)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                        case 3: throw new Error();
                        case 4: return [4 /*yield*/, this.handlers.refresh.parseResponse(response)];
                        case 5:
                            data = _a.sent();
                            if (!data.accessToken || !data.refreshToken || !data.expires) {
                                throw new Error('parsed refresh data needs to contain `accessToken`, `refreshToken` and `expires`');
                            }
                            this.setSessionCookies(res, data);
